...
3. Stand up a graph-explorer configured to the fuseki kennedy dataset
4. Add all members to Graph View, configure namespaces, add relationship predicate labels, expand all relationships, and optimize the graph view layout
